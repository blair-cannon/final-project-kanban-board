    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('favorite_park', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='myapp.park')),
                ...
                ('socialization', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='myapp.socialization')),
                ('tags', models.ManyToManyField(blank=True, null=True, to='myapp.tag')),
